document.addEventListener("DOMContentLoaded", () => {
    ...
    const openingScript = [
        ...
        { text: '“That’s what you always say, {playerName}.” She frowns at me, clearly exasperated.', speakers: 'tifa', primarySpeaker: 'tifa' },
        ...
        { text: '“{playerName}!” Then, someone calls me.' },
        ...
        { text: '“{playerName}.”', speakers: 'aerith', primarySpeaker: 'aerith' },
    ...
    const victoryGame = [
        ...
        { text: '“{playerName}.”', speaker: 'miniroth', primarySpeaker: [] },
    ...
    // speaker and primary speaker trigger dim
    ...
    // typing animations during dialogues
    ...
    // change scene background helper
    ...
    function showDialogue() {
        ...
        // apply dim characters when no speaker
        ...
        if (currentScene.text) {
            const dialogueWithName = currentScene.text.replace(/{playerName}/g, playerName);
            typeText(dialogueWithName);
        }
    }
    ...
    function startStoryGame() {
        ...
        // 8 choices and only 1 is correct. 3 correct answers required, else bad end
    ...
    // post dialogue after the mini game
    ...
    // trigger name input first
    let playerName = '';
    
    function nameCard() {
        // hide menu, show name box
    ...
    document.getElementById('start-button').addEventListener('click', nameCard);
